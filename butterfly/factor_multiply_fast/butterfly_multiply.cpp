...
at::Tensor butterfly_multiply_untied_forward_max5_fast(const at::Tensor &twiddle,
                                                       const at::Tensor &input,
                                                       bool increasing_stride) {
  /* Parameters:
  ...
  */
  ...
  #if !BFLY_MAX5_BENCHMARK
  butterfly_multiply_untied_forward_max5_fast_cuda(twiddle, input, output, increasing_stride);
  #else
  butterfly_multiply_untied_forward_max5_fast_cuda_benchmark(twiddle, input, output, increasing_stride);
  #endif
  return output;
}
...
std::vector<at::Tensor> butterfly_multiply_untied_forward_backward_max5_fast(const at::Tensor &twiddle,
                                                                             const at::Tensor &input,
                                                                             const at::Tensor &grad,
                                                                             bool increasing_stride) {
  /* Parameters:
  ...
  */
  ...
  auto d_input = torch::empty_like(input);
  auto d_twiddle = torch::zeros_like(twiddle);
  TORCH_CHECK(input.is_cuda(), "butterfly_multiply_untied_forward_backward_max5_fast: only supports CUDA");
  #if !BFLY_MAX5_BENCHMARK
  butterfly_multiply_untied_forward_backward_max5_fast_cuda(twiddle, input, grad,
                                                            d_twiddle, d_input,
                                                            increasing_stride);
  #else
  butterfly_multiply_untied_forward_backward_max5_fast_cuda_benchmark(twiddle, input, grad,
                                                                      d_twiddle, d_input,
                                                                      increasing_stride);
  #endif
  return {d_twiddle, d_input} ;
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("butterfly_multiply_untied_forward_max5_fast",
        &butterfly_multiply_untied_forward_max5_fast,
        "Butterfly multiply untied forward max5_fast");
  ...
  m.def("butterfly_multiply_untied_forward_backward_max5_fast",
        &butterfly_multiply_untied_forward_backward_max5_fast,
        "Butterfly multiply untied forward backward max5_fast");
