                    ...
                    for tied_weight in [True, False]:
                        for increasing_stride in [True, False]:
                            for ortho_init in [False, True]:
                                b = Butterfly(in_size, out_size, True, complex, tied_weight, increasing_stride, ortho_init).to(device)
            ...
            for in_size, out_size in [(7, 15), (15, 7)]:
                for complex in [False, True]:
                    for tied_weight in [True, False]:
                        for increasing_stride in [True, False]:
                            for ortho_init in [False, True]:
                                b_bmm = ButterflyBmm(in_size, out_size, matrix_batch, True, complex, tied_weight, increasing_stride, ortho_init).to(device)
